package net.termineter.tutorialmod.entity.client;
...
public class GeckoModel<T extends GeckoEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, "gecko"), "main");
