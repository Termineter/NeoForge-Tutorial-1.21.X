package net.termineter.tutorialmod.entity;
...
import net.termineter.tutorialmod.entity.custom.ChairEntity;
...
public class ModEntities {
    ...
    public static final Supplier<EntityType<ChairEntity>> CHAIR_ENTITY =
            ENTITY_TYPES.register("chair_entity",
                    () -> EntityType.Builder.of(ChairEntity::new, MobCategory.MISC).sized(0.5f, 0.5f).build("chair_entity"));
