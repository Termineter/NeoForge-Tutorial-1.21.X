...
import net.termineter.tutorialmod.loot.AddItemModifier;
import org.checkerframework.checker.units.qual.A;

import java.util.concurrent.CompletableFuture;

public class ModGlobalLootModiferProvider extends GlobalLootModifierProvider {
    public ModGlobalLootModiferProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
